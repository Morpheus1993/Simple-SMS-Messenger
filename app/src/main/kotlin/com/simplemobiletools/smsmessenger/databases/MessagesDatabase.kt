...
abstract class MessagesDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_4_5 = object : Migration(4, 5) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.apply {
                    execSQL("ALTER TABLE messages ADD COLUMN headerRSA INTEGER NOT NULL DEFAULT -1")
                    execSQL("ALTER TABLE messages ADD COLUMN validationFlag INTEGER NOT NULL DEFAULT -1")
                }
            }
        }
    }
